...
def introduction():
    responses =[
        ...
        "Welcome!!!!, Iam bot. I will help you to choose your mobile model based on your prefernce."
    ]
...
def bot_features():
    print("--->This bot will suggest a user to select a mobile model according to their basic choice of prefernce.")
    print("--->This bot will ask the user for their choice to suggest them the appropriate model in realme.")
    print("--->It will respond to user input appopriatly to suggest the best model in realme.")
    print("________")
...
def mobile_model():
    ...
    if ram == 6 or ram == 12  and processor == 665:
        ...
        print("Sorry! there was no such model in realme ")
        print("________")
...
def show_menu():
    ...
    print("2.Know your realme mobile models available based on your prefrences.")
    print("3.End the chat if your got the model of your model.")
    print("________")
    try:
        return int(input("Enter your choise from 1 to 3: "))
    except:
